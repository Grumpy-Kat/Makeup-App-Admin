...
class InfoBoxState extends State<InfoBox> with TickerProviderStateMixin {
  ...
  void setValues() {
    if(widget.swatch != null) {
      _hasSetValues = true;
      String colorName = widget.swatch.colorName;
      _colorName = globalWidgets.toTitleCase(colorName == '' ? getString(getColorName(widget.swatch.color)) : (colorName.contains('color_') ? getString(colorName) : colorName));
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                            ...
                            navigation.push(
                              ...
                              SwatchScreen(paletteId: widget.swatch.paletteId, swatchId: widget.swatch.id),
                            );
                          },
                          child: Container(
